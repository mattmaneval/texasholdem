...
const HandRankings = () => (
  <SectionHandRankings>
    ...
    <p>
      The rank of each card used in Texas Hold&apos;em when forming a five-card high
      poker hand in order of highest to lowest rank: Ace, King, Queen, Jack, 10,
      9, 8, 7, 6, 5, 4, 3, and 2.
    </p>
    ...
    <p>
      1A hand that consists of five cards of the same suit in consecutive ranking.
      King, queen, jack, 10 and 9 is the highest ranked straight flush and a 5,
    ...
    <h3>#6 Straight</h3>
    <p>
      A hand that consists of five cards that are in consecutive ranking, but
      that are not the same suit. An ace, king, queen, jack and 10 is the
      highest ranked straight and a 5, 4, 3, 2 and ace is the lowest ranked straight.
    </p>
    <Straight />
    ...
    <p>
      ...
      highest ranked three of a kind and three 2’s is the lowest ranked three of a kind.
    </p>
    <ThreeOfAKind />
